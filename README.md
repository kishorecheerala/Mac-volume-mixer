<img src="assets/icon.png" width="170" height="170" alt="Mac Volume Mixer app icon" align="left"/>

<h3>Mac Volume Mixer</h3>
...
<a href="https://github.com/kishorecheerala/Mac-volume-mixer/releases/latest/download/Mac.Volume.Mixer.dmg"><img src="assets/download-badge.svg" alt="Download for macOS" height="48"/></a>

<br clear="all"/>

<p align="center">
  <a href="https://github.com/kishorecheerala/Mac-volume-mixer/releases/latest"><img src="https://img.shields.io/github/v/release/kishorecheerala/Mac-volume-mixer?style=for-the-badge&labelColor=1c1c1e&color=0A84FF&logo=github&logoColor=white" alt="Latest Release"></a>
  <a href="https://github.com/kishorecheerala/Mac-volume-mixer/releases"><img src="https://img.shields.io/github/downloads/kishorecheerala/Mac-volume-mixer/total?style=for-the-badge&labelColor=1c1c1e&color=3a3a3c" alt="Downloads"></a>
...
<p align="center">
  <img src="assets/screenshot-main.png" alt="Mac Volume Mixer popup showing per-app volume control, multi-device output routing with picker popover, AutoEQ headphone correction, and device-level volume sliders" width="700">
</p>
<p align="center">
  <img src="assets/screenshot-eq.png" alt="Mac Volume Mixer showing the Brave Browser app row expanded with the EQ panel open and a Vocal Clarity preset selected" width="700">
</p>

## Install

**Manual** — [Download latest release](https://github.com/kishorecheerala/Mac-volume-mixer/releases/latest)

## Quick Start

1. Install Mac Volume Mixer and launch it from your Applications folder
2. Grant **Screen & System Audio Recording** permission when prompted
3. Click the Mac Volume Mixer icon in your menu bar. Apps playing audio appear automatically.

That's it. Adjust sliders, route audio, and explore EQ from the menu bar.

> **Tip:** Want Mac Volume Mixer to auto-switch to a specific device when you connect it? Open edit mode (pencil icon) and drag it above the built-in speakers. This is a one-time setup. Your preferred order is saved permanently.
...
- **Ignore apps** — Completely disengage Mac Volume Mixer from specific apps. Tears down the audio tap so the app returns to normal macOS audio
...
- **Toggle the popup from anywhere** — Bind a hotkey to **Toggle Mac Volume Mixer Popup** and the menu bar opens or closes on demand, including from full-screen apps.
...
- **Device priority** — Choose which device Mac Volume Mixer switches to when a new device connects; auto-fallback on disconnect
...
- **Smart volume backend** — Mac Volume Mixer auto-picks hardware, DDC, or software volume per device. If the hardware slider on a USB DAC or HDMI output doesn't actually control level, force software volume from the device inspector and Mac Volume Mixer remembers the choice for that device
...
### 🎨 Appearance
- **Light or Dark theme** — Settings → General → Theme matches macOS or locks Mac Volume Mixer to Light or Dark. The menu bar popup, every popover, and the volume HUD switch immediately.
...
- **[URL Schemes](guide/url-schemes.md)** — Automate Mac Volume Mixer from Terminal, [Shortcuts](https://support.apple.com/guide/shortcuts-mac), [Raycast](https://raycast.com), or scripts
- **[Troubleshooting](guide/troubleshooting.md)** — Permission issues, missing apps, audio problems

## Contributing

- **Star this repo** — Help others discover Mac Volume Mixer
- **Report bugs** — [Open an issue](https://github.com/kishorecheerala/Mac-volume-mixer/issues)

### Build from Source

```bash
git clone https://github.com/kishorecheerala/Mac-volume-mixer.git
cd "Mac Volume Mixer"
...
Special thanks to the original **FineTune** team ([ronitsingh10/FineTune](https://github.com/ronitsingh10/FineTune)) and all open-source contributors for developing the foundational audio engineering and CoreAudio tap infrastructure that powers **Mac Volume Mixer**.
